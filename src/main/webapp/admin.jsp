...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="#">Beacon Crawl for Glass</a>
    </div>
  </div>
</div>
    ...
    <div class="span4">
      ...
      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        ...
        <button class="btn btn-block" type="submit">
          Insert the "Welcome" bundle</button>
      </form>

      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        <input type="hidden" name="operation" value="insertVignetteBundle">
        <button class="btn btn-block" type="submit">
          Insert the "Vignette" bundle</button>
      </form>

      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        <input type="hidden" name="operation" value="insertItem">
        <textarea class="span4" name="message">Welcome, Glass Explorer, to the Beacon Crawl!</textarea><br/>
        <button class="btn btn-block" type="submit">
    ...
    <div class="span4">
      ...
      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        ...
        <button class="btn btn-block btn-danger" type="submit">
          Delete Beacon Crawl Contact
        </button>
      </form>
      <% } %>

      <h3>Voice Commands</h3>
      <p>The "Beacon Crawl" contact also accepts the <strong>take a
        note</strong> command. Take a note with the "Beacon Crawl" contact
